...
func (m *DsbCommon) sbomFromArchive(plan *ReleasePlan, archive *dagger.File, trivyImage string) *dagger.File {
	trivyImage = defaultString(trivyImage, defaultTrivyImage)
	return dag.Container().
		From(trivyImage).
		WithMountedCache("/root/.cache/trivy", dag.CacheVolume("dsb-common-trivy-cache")).

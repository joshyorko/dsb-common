...
func (m *DsbCommon) buildah(
	...
	localRef := fmt.Sprintf("%s:latest", defaultImageName)
	...
	container := dag.Container().
		...
		WithWorkdir("/src").
		WithMountedCache("/var/lib/containers", dag.CacheVolume("dsb-common-buildah-containers")).
